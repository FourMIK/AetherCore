...
pub use schema::{HealthMetrics, MeshEvent, MeshHealthPayload, RevocationPayload, RevocationReason as SchemaRevocationReason};
...
pub use websocket::{
    HealthMetrics as WsHealthMetrics, MeshHealthMessage, RevocationCertificate as WsRevocationCertificate,
