...
- `LATTICE_SYNTHETIC_SCENARIO` (default `sf_bay_maritime_incursion_v1`)
...
- `LATTICE_SYNTHETIC_INGEST_INTERVAL_MS` (default inherits `LATTICE_POLL_INTERVAL_MS`; use `2000` for accelerated demo pacing)
